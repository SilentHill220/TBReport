...
def probe():
    ...
    print(f"Got Job ID: {job_id}. Waiting 5s before probing...")
    time.sleep(5)
    ...
    endpoints_to_try = [
        ...
        f"https://www.teambition.com/api/project/{project_id}/task/exports/{job_id}",
        
        # Job specific
        f"https://www.teambition.com/api/jobs/{job_id}",
        f"https://www.teambition.com/api/export_jobs/{job_id}",
        
        # Legacy/Other patterns
        f"https://www.teambition.com/api/projects/{project_id}/export/{job_id}",
        f"https://www.teambition.com/api/v2/task/export/{job_id}",
    ]
    ...
    for url in endpoints_to_try:
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if "downloadUrl" in r.text or "fileKey" in r.text or "https://" in r.text:
                    print("!!! FOUND POTENTIAL DOWNLOAD URL !!!")
